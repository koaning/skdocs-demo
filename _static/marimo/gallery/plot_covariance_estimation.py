...
def _():
    ...
    return X_test, X_train, coloring_matrix, np
...
@app.cell
def _(X_test, X_train, coloring_matrix, np):
    ...
    return ShrunkCovariance, loglik_real, negative_logliks, shrinkages
...
@app.cell
def _(ShrunkCovariance, X_test, X_train, shrinkages):
    ...
    return cv, loglik_lw, loglik_oa, lw, oa
