...
def _(X_train, y_train):
    ...
    return adaboost_clf, n_estimators, weak_learner
...
@app.cell
def _(X_test, X_train, weak_learner, y_test, y_train):
    ...
    return (
        ...
        weak_learners_misclassification_error,
    )
...
@app.cell
def _(adaboost_clf, n_estimators, pd):
