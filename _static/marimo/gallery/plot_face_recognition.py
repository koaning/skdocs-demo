...
@app.cell
def _(PCA, X_test, X_train, h, time, w):
    n_components = 150
    ...
    print('done in %0.3fs' % (time() - _t0))
    return X_test_pca, X_train_pca, eigenfaces
...
@app.cell
def _(RandomizedSearchCV, SVC, X_train_pca, loguniform, time, y_train):
...
@app.cell
def _(X_test, h, plot_gallery, target_names, w, y_pred, y_test):
...
@app.cell
def _(eigenfaces, h, plot_gallery, plt, w):
