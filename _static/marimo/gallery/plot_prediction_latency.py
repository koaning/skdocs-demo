...
@app.cell
def _(RandomForestRegressor, SGDRegressor, SVR, benchmark, np):
    configuration = {
        "n_train": int(1e3),
        "n_test": int(1e2),
        "n_features": int(1e2),
...
@app.cell
def _(Ridge, configuration, n_feature_influence, plot_n_features_influence):
    percentile = 90
...
@app.cell
def _(benchmark_throughputs, configuration, plot_benchmark_throughput):
