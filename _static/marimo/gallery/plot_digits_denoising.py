...
def _():
    ...
    return X, np, train_test_split, y
...
def _(X, np, train_test_split, y):
    ...
    return X_test, X_test_noisy, X_train_noisy
...
@app.cell
def _(X_test, X_test_noisy, np, plot_digits):
...
@app.cell
def _(X_test_noisy, kernel_pca, pca):
