...
def _():
    ...
    class NaivelyCalibratedLinearSVC(LinearSVC):
        ...
        def predict_proba(self, X):
            ...
            return proba
    return NaivelyCalibratedLinearSVC, np


@app.cell
def _(NaivelyCalibratedLinearSVC, np):
    ...
    return CalibrationDisplay, clf_list


@app.cell
def _(CalibrationDisplay, X_test, X_train, clf_list, y_test, y_train):
...
def _(mo):
    ...
    * :class:`~sklearn.ensemble.RandomForestClassifier`'s prediction histogram
    ...
    .. [3] [Obtaining calibrated probability estimates from decision trees and
           naive Bayesian classifiers](https://cseweb.ucsd.edu/~elkan/calibrated.pdf)
