...
def _(np):
    ...
    def best_low_complexity(cv_results):
        ...
        return best_idx
    return best_low_complexity, lower_bound
...
@app.cell
def _(LogisticRegression, PCA, Pipeline):
    pipe = Pipeline(
        [
...
@app.cell
def _(GridSearchCV, ShuffleSplit, best_low_complexity, param_grid, pipe):
    grid = GridSearchCV(
        pipe,
...
@app.cell
def _(grid, lower_bound, np, pl, plt):
    ...
    # # Adjust layout
    plt.tight_layout()
    return best_components, best_score, lower, results_df, test_scores
...
@app.cell
def _(best_components, best_score, lower, np, pl, results_df, test_scores):
