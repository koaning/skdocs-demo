...
@app.cell
def _(X_test, X_train, classifiers, y_test, y_train):
    ...
    for name, clf in classifiers.items():
        ...
        RocCurveDisplay.from_estimator(clf, X_test, y_test, ax=ax_roc, name=name, curve_kwargs=dict(color=color, linestyle=linestyle))
        DetCurveDisplay.from_estimator(clf, X_test, y_test, ax=ax_det, name=name, color=color, linestyle=linestyle)
    plt.legend()
    plt.show()
    return
