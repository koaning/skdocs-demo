...
@app.cell
def _(BaseEstimator, ClassifierMixin, np):
...
@app.cell
def _(ExampleClassifier, print_routing):
...
@app.cell
def _(ExampleClassifier, print_routing):
    _est = ExampleClassifier().set_fit_request(sample_weight=False).set_predict_request(groups=True).set_score_request(sample_weight=False)
    print_routing(_est)
    return
...
@app.cell
def _(ExampleClassifier, X, my_groups, my_weights, y):
    _est = ExampleClassifier()
    _est.fit(X, y, sample_weight=my_weights)
    _est.predict(X[:3, :], groups=my_groups)
    return
...
@app.cell
def _(ExampleClassifier, MetaClassifier, X, my_weights, y):
...
@app.cell
def _(X, meta_est, my_groups, my_weights, y):
    try:
...
@app.cell
def _(ExampleClassifier, MetaClassifier, X, my_groups, my_weights, y):
    meta_est_1 = MetaClassifier(estimator=ExampleClassifier().set_fit_request(sample_weight=True).set_predict_request(groups=False))
    try:
        meta_est_1.fit(X, y, sample_weight=my_weights).predict(X[:3, :], groups=my_groups)
    except TypeError as e:
        print(e)
    return
...
@app.cell
def _(ExampleClassifier, MetaClassifier, X, my_weights, y):
    meta_est_2 = MetaClassifier(estimator=ExampleClassifier().set_fit_request(sample_weight='aliased_sample_weight'))
    meta_est_2.fit(X, y, aliased_sample_weight=my_weights)
    return (meta_est_2,)
...
@app.cell
def _(X, meta_est_2, my_weights, y):
    try:
        meta_est_2.fit(X, y, sample_weight=my_weights)
    except TypeError as e:
        print(e)
    return
...
@app.cell
def _(meta_est_2, print_routing):
    print_routing(meta_est_2)
    return
...
@app.cell
def _(MetaClassifier, X, meta_est_2, my_weights, y):
    meta_meta_est = MetaClassifier(estimator=meta_est_2).fit(X, y, aliased_sample_weight=my_weights)
    return
...
def _(
    ...
    class RouterConsumerClassifier(MetaEstimatorMixin, ClassifierMixin, BaseEstimator):
        ...
        def predict(self, X, **predict_params):
            ...
            return self.estimator_.predict(X, **routed_params.estimator.predict)
    return (RouterConsumerClassifier,)
...
@app.cell
def _(ExampleClassifier, RouterConsumerClassifier, print_routing):
    meta_est_3 = RouterConsumerClassifier(estimator=ExampleClassifier())
    print_routing(meta_est_3)
    return
...
@app.cell
def _(ExampleClassifier, RouterConsumerClassifier, print_routing):
    meta_est_4 = RouterConsumerClassifier(estimator=ExampleClassifier().set_fit_request(sample_weight=True))
    print_routing(meta_est_4)
    return
...
@app.cell
def _(ExampleClassifier, RouterConsumerClassifier, print_routing):
    meta_est_5 = RouterConsumerClassifier(estimator=ExampleClassifier()).set_fit_request(sample_weight=True)
    print_routing(meta_est_5)
    return
...
@app.cell
def _(ExampleClassifier, RouterConsumerClassifier, print_routing):
    meta_est_6 = RouterConsumerClassifier(estimator=ExampleClassifier().set_fit_request(sample_weight='clf_sample_weight')).set_fit_request(sample_weight='meta_clf_sample_weight')
    print_routing(meta_est_6)
    return (meta_est_6,)
...
@app.cell
def _(X, meta_est_6, my_other_weights, my_weights, y):
    meta_est_6.fit(X, y, sample_weight=my_weights, clf_sample_weight=my_other_weights)
    return
...
@app.cell
def _(ExampleClassifier, RouterConsumerClassifier, print_routing):
    meta_est_7 = RouterConsumerClassifier(estimator=ExampleClassifier().set_fit_request(sample_weight='aliased_sample_weight'))
    print_routing(meta_est_7)
    return
...
@app.cell
def _(LinearRegression, MetaRegressor, X, my_weights, y):
...
@app.cell
def _(LinearRegression, WeightedMetaRegressor, X, my_weights, warnings, y):
    with warnings.catch_warnings(record=True) as _record:
