...
def _():
    ...
    return X_test, X_train, true_coef, y_test, y_train
...
def _(X_train, enet, y_train):
    ...
    return alphas, idx_avg_max_test_score
...
@app.cell
def _(X_test, X_train, alphas, enet, idx_avg_max_test_score, y_test, y_train):
