...
def _(X, train_test_split, y):
    ...
    return X_test, X_train, params, y_test, y_train
...
@app.cell
def _(X_test, X_train, ensemble, mean_squared_error, params, y_test, y_train):
...
@app.cell
def _(X_test, mean_squared_error, np, params, plt, reg, y_test):
